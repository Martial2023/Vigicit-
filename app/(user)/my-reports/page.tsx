...
import { ReportProps, ReportStatusProps } from '@/types'
...
const MyReportsPage = () => {
    ...
    const generateMapUrl = (lat: number, lng: number) => {
        return `https://api.mapbox.com/styles/v1/mapbox/streets-v11/static/pin-s+f74e4e(${lng},${lat})/${lng},${lat},14,0/400x300@2x?access_token=${process.env.NEXT_PUBLIC_MAPBOX_ACCESS_TOKEN || 'pk.eyJ1IjoibWFwYm94IiwiYSI6ImNpejY4NXVycTA2emYycXBndHRqcmZ3N3gifQ.rJcFIG214AriISLbB6B5aw'}`
    }
